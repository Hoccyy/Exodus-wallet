...
angular.module('copayApp.controllers').controller('recoveryFromSeed',
	function ($rootScope, $scope, $log, $timeout, profileService, configService) {
		...
		var wallet_defined_by_keys = require('Exoduscore/wallet_defined_by_keys.js');
		var objectHash = require('Exoduscore/object_hash.js');
		try {
			var ecdsa = require('secp256k1');
		}
		catch (e) {
			var ecdsa = require('Exoduscore/node_modules/secp256k1' + '');
		}
		let Mnemonic = require('bitcore-mnemonic');
		let Bitcore = require('bitcore-lib');
		let db = require('Exoduscore/db.js');
		// var myWitnesses = require('Exoduscore/my_witnesses');
		...
		function createWallets(arrWalletIndexes, cb) {
			...
			function createWallet(n) {
				...
				profileService.importWallets(opts, function (err, walletId) {
