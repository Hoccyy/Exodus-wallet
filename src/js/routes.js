...
angular
    ...
    .config(function (historicLogProvider, $provide, $logProvider, $stateProvider, $urlRouterProvider, $compileProvider, $qProvider) {
        ...
        $stateProvider
            ...
            .state('LockIn', {
                url: '/LockIn?walletType&walletId&address&name&image&ammount&mnemonic&mnemonicEncrypted&_address',
                views: {
                    'main': {
                        templateUrl: 'views/LockIn.html'
                    }
                }
            })
            .state('LockExtract', {
                ...
                views: {
                    'main': {
                        templateUrl: 'views/LockExtract.html'
                    }
                }
            })
    ...
    .run(function ($rootScope, $state, $log, uriHandler, isCordova, profileService, $timeout, nodeWebkit, uxLanguage, uxCurrency, animationService) {
        ...
        /*if (nodeWebkit.isDefined()) {
          ...
          try {
            nativeMenuBar.createMacBuiltin("Exodus");
          } catch (e) {
