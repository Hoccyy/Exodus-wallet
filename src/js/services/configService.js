...
angular.module('copayApp.services').factory('configService', function (storageService, lodash, $log, isCordova) {
	...
	root.defaultImages = {
		'EXO' : ['./img/exodustimg.png','EXO-Wallet','EXO'],
		'BTC' : ['./img/btcltimg.png','BTC-Wallet','BTC'],
        'ETH' : ['./img/ethltimg.png','ETH-Wallet','ETH'],
        'SNC' : ['./img/sncltimg.png','SNC-Wallet','SNC'],
	}
    ...
    root.getUnitValue = function (code) {
        return defaultConfig.wallet.settings[code];
    }
	...
	root.set = function (newOpts, cb) {
		...
		storageService.getConfig(function (err, oldOpts ) {
            /**
             * 优化移动端创建钱包后报错：JSON input is undefined
             */
			if (oldOpts != '' && lodash.isString(oldOpts)) {
