...
#define MyAppURL "https://www.exo.one"
...
[Files]
; Source: "..\Exodusbuilds\Exodus-test\win32\Exodus.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\..\Exodusbuilds\{#MyAppPackageName}\win32\*"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs
