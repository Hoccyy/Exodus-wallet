module.exports = function (grunt) {
	...
	grunt.initConfig({
		...
		exec: {
			...
			osx64: {
				command: '../Exodusbuilds/build-osx.sh osx64'
			},
			osx32: {
				command: '../Exodusbuilds/build-osx.sh osx32'
			}
		},
		watch: {
			options: {
		...
		concat: {
			...
			js: {
				...
				dest: 'public/Exodus.js'
			},
			css: {
				src: ['src/css/*.css'],
				dest: 'public/css/Exodus.css'
			},
			foundation: {
		...
		uglify: {
			...
			prod: {
				files: {
					'public/Exodus.js': ['public/Exodus.js'],
		...
		copy: {
			...
			node_modules: {
				expand: true,
				src: 'node_modules/**',
				dest: '../Exodusbuilds/Exodus/win64/'
			},
			...
			linux: {
				...
				files: [{
					expand: true,
					cwd: './webkitbuilds/',
					src: ['Exodus.desktop', '../public/img/icons/icon-white-outline.ico', '../public/img/icons/icon-white-256.png'],
					dest: '../Exodusbuilds/Exodus/linux32/',
					flatten: true,
					filter: 'isFile',
					options: { timestamp: true, mode: true }
				}, {
					...
					cwd: './webkitbuilds/',
					src: ['Exodus.desktop', '../public/img/icons/icon-white-outline.ico', '../public/img/icons/icon-white-256.png'],
					dest: '../Exodusbuilds/Exodus/linux64/',
					flatten: true,
					filter: 'isFile',
					options: { timestamp: true, mode: true }
				}]
		...
		nwjs: {
			options: {
				...
				macPlist: {
					CFBundleURLTypes: [{
						CFBundleURLName: 'Exodus action',
						CFBundleURLSchemes: ['Exodus']
		...
		compress: {
			linux32: {
				options: {
					archive: '../Exodusbuilds/Exodus-linux32.zip'
				},
				expand: true,
				cwd: '../Exodusbuilds/Exodus/linux32/',
				src: ['**/*'],
				dest: 'Exodus-linux32/'
			},
			linux64: {
				options: {
					archive: '../Exodusbuilds/Exodus-linux64.zip'
				},
				expand: true,
				cwd: '../Exodusbuilds/Exodus/linux64/',
				src: ['**/*'],
				dest: 'Exodus-linux64/'
			}
		},
		...
		debian_package: {
			linux64: {
				files: [{
					expand: true,
					cwd: '../Exodusbuilds/Exodus-test/linux64/',
					src: ['**/*'],
					dest: '/opt/Exodus-test/'
				}],
				options: {
					maintainer: {
						name: 'Exodus',
						email: 'Exodus@exo.one'
					},
		...
		clean: {
			linux64: {
				options: { force: true },
				files: [{
					src: '../Exodusbuilds/Exodus/linux64/node_modules/grunt*',
					src: '../Exodusbuilds/Exodus/linux64/node_modules/karma*'
				}]
			},
			win64: {
				options: { force: true },
				files: [{
					src: '../Exodusbuilds/Exodus/win64/node_modules/grunt*',
					src: '../Exodusbuilds/Exodus/win64/node_modules/karma*',
					src: '../Exodusbuilds/Exodus/win64/node_modules/babel*'
				}]
			},
			osx64: {
				options: { force: true },
				files: [{
					src: '../Exodusbuilds/Exodus/osx64/node_modules/grunt*',
					src: '../Exodusbuilds/Exodus/osx64/node_modules/karma*',
					src: '../Exodusbuilds/Exodus/osx64/node_modules/babel*'
				}]
			}
		}
	});
